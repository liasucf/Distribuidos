...
def main():    
	...
	frame_4_label = ttk.Label(frame4, text='Lampada')
	...
	valor_lampada = ttk.Label(frame4,text='',image = leitor, compound='center')
	valor_lampada.grid(row=1, column=0)
