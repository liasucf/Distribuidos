...
mqttc = mqtt.Client(client_id='Som')
...
def main():    
	...
	frame_4_label = ttk.Label(frame4, text='Som')
	...
	valor_som = ttk.Label(frame4,text='',image = leitor, compound='center')
	valor_som.grid(row=1, column=0)
