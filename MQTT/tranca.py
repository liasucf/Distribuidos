...
mqttc = mqtt.Client(client_id='tranca')
...
def main():    
	...
	valor_status = ttk.Label(frame4,text='',image = leitor, compound='center')
	valor_status.grid(row=1, column=0)
